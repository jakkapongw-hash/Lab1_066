	...
	<table width="1238" height="530" border="0">
		...
		<tr>
			...
			<td width="190" bgcolor="#FFFF66"><ul>
				<li><a href="home.php">หน้าแรกค้าบบบบบเบ๋บี๋ๆๆๆๆๆๆๆ-..-</li>
				<li><a href="room.php">ห้องพัก&ราคา - ราคา100,000,000,000,000,000,000,000,000,000,000 บาท</li>
				<li><a herf="guest.php">สมุดเยี่ยม</li>
				<li><a href="contact.php">ติดต่อสวัสดีค้าบบบบบบบบบบบบบบบ ผมมมมมมมมมมม</li>
				</ul><p>
